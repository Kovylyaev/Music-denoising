...
**Основная метрика:** SNR. Это простая и понятная метрика. Указывает на то, насколько сигнал доминирует над шумом, что соответствует лучшему качеству звука.


### Почему выбрана одна метрика, а не другая + обзор метрик

Ниже представлен анализ семи метрик, используемых для оценки качества обработки звука, в частности в задачах шумоподавления. Рассмотрены как классические показатели (SNR, MSE), так и метрики, учитывающие особенности восприятия речи (PESQ, STOI) и специфические аспекты искажений (SDR, SRMR, FW-SSMR).
